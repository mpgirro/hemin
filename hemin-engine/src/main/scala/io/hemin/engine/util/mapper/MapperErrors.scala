...
object MapperErrors {
  ...
  private[mapper] def mapperErrorIndexToPodcast(value: IndexDoc): EngineException =
  ...
  private[mapper] def mapperErrorLuceneToPodcast(value: org.apache.lucene.document.Document): EngineException =
  ...
  private[mapper] def mapperErrorSolrToPodcast(value: org.apache.solr.common.SolrDocument): EngineException =
  ...
  private[mapper] def mapperErrorLuceneToIndexDoc(value: org.apache.lucene.document.Document): EngineException =
  ...
  private[mapper] def mapperErrorSolrToIndexDoc(value: org.apache.solr.common.SolrDocument): EngineException =
  ...
  private[mapper] def mapperErrorPodcastToIndexDoc(value: Podcast): EngineException =
  ...
  private[mapper] def mapperErrorEpisodeToIndexDoc(value: Episode): EngineException =
  ...
  private[mapper] def mapperErrorUnsupportedIndexDocumentType(value: String): EngineException =
  ...
  private[mapper] def mapperErrorIndexFieldNotPresent(value: String): EngineException =
  ...
  private[mapper] def mapperErrorIndexToEpisode(value: IndexDoc): EngineException =
  ...
  private[mapper] def mapperErrorLuceneToEpisode(value: org.apache.lucene.document.Document): EngineException =
  ...
  private[mapper] def mapperErrorSolrToEpisode(value: org.apache.solr.common.SolrDocument): EngineException =
  ...
  private[mapper] def mapperErrorIndexToLucene(value: IndexDoc): EngineException =
  ...
  private[mapper] def mapperErrorIndexToSolr(value: IndexDoc): EngineException =
