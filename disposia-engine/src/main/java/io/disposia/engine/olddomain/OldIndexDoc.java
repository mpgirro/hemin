...
@JsonSerialize(as = ImmutableOldIndexDoc.class)
@JsonDeserialize(as = ImmutableOldIndexDoc.class)
public interface OldIndexDoc {
    ...
    */
    ...
    @Nullable
    String getPodcastTitle(); // will be the same as the title if marshalled from a OldPodcast
